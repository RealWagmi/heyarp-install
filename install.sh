...
c_info ""
c_info "READ THE ONBOARDING GUIDE (covers setup, registration, the work cycle):"
c_info "    ${GUIDE_URL}"
c_info "  After install, a built-in primer is also available:  heyarp guide --setup"
c_info ""
...
printf '\n'
c_info "================================================================"
c_info "NEXT — read the onboarding guide before using heyarp:"
c_info "    ${GUIDE_URL}"
c_info "  Or run the built-in primer:  heyarp guide --setup"
c_info ""
c_info "If opengrep (L2) is missing later, run:  heyshield install-opengrep"
c_info "It covers: server/RPC config, agent registration + wallet funding,"
c_info "the handshake -> delegation -> work -> receipt cycle, and the watchdog."
c_info "================================================================"
